...
microk8s helm install threat-db-api oci://ghcr.io/ngcloudsec/charts/threat-db --version 0.4.0 --set persistence.storageClass="ssd-hostpath" --set persistence.size="1Gi"
microk8s kubectl get pods
```
